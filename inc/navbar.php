    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item navbar-widtd">
            <a class="nav-link navbar-text-link" href="#">ซื้อรถยนต์</a>
          </li> 
          <li class="nav-item navbar-widtd">
            <a class="nav-link navbar-text-link" href="#">ขายรถยนต์</a>
          </li>
          <li class="nav-item navbar-widtd">
            <a class="nav-link navbar-text-link" href="#">ติดต่อเรา</a>
          </li> 
        </ul>
